...
interface IJBSplitHook is IERC165 {
    ...
    /// @param data The data passed by the terminal/controller to the split hook as a `JBSplitHookData` struct:
    function process(JBSplitHookData calldata data) external payable;
}
