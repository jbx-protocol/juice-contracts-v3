...
contract JBRulesets is JBControllerUtility, IJBRulesets {
    ...
    function getRulesetStruct(uint256 _projectId, uint256 _rulesetId)
        external
        view
        override
    ...
    function latestQueuedOf(uint256 _projectId)
        external
        view
        override
        returns (JBRuleset memory ruleset, JBApprovalStatus approvalStatus)
    {
        ...
        approvalStatus =
            _approvalStatusOf(_projectId, ruleset.rulesetId, ruleset.start, ruleset.basedOn);
    }
        ...
        returns (JBApprovalStatus)
    {
        ...
        return _approvalStatusOf(_projectId, _ruleset.rulesetId, _ruleset.start, _ruleset.basedOn);
    }
    ...
    function _configureIntrinsicPropertiesFor(
        ...
        if (
            ...
            _baseRuleset = _getStructFor(_projectId, _baseRuleset.basedOn);
        }
    ...
    function _initializeRulesetFor(
        ...
        if (_baseRuleset.cycleNumber == 0) {
            ...
            _packAndStoreIntrinsicPropertiesOf(
                _rulesetId, _projectId, _cycleNumber, _weight, _baseRuleset.rulesetId, _start
            );
        }
    ...
    function _mockRulesetBasedOn(JBRuleset memory _baseRuleset, bool _allowMidRuleset)
        private
        view
        ...
        returns (uint256 weight)
    {
        ...
        if (_decayMultiple > _DECAY_MULTIPLE_CACHE_LOOKUP_THRESHOLD) {
            ...
            JBRulesetWeightCache memory _cache = _weightCache[_baseRuleset.rulesetId];
    ...
    function _deriveNumberFrom(JBRuleset memory _baseRuleset, uint256 _start)
        private
        pure
        returns (uint256)
    {
        ...
        returns (JBRuleset memory ruleset)
    {
        ...
        ruleset.basedOn = uint256(uint56(_packedIntrinsicProperties >> 88));
