    ...
    IJBFundAccessConstraintsStore
{
    ...
    function distributionLimitOf(
        ...
        uint256 _data =
            _packedDistributionLimitDataOf[_projectId][_configuration][_terminal][_token];
    ...
    function overflowAllowanceOf(
        ...
        // Get a reference to the packed data.
        uint256 _data =
            _packedOverflowAllowanceDataOf[_projectId][_configuration][_terminal][_token];
    ...
    function setFor(
        ...
        for (uint256 _i; _i < _numberOfFundAccessConstraints;) {
            ...
            if (_fundAccessConstraints[_i].distributionLimit > 0) {
                _packedDistributionLimitDataOf[_projectId][_configuration][_fundAccessConstraints[_i]
                    .terminal][_fundAccessConstraints[_i].token] = _fundAccessConstraints[_i]
                    .distributionLimit | (_fundAccessConstraints[_i].distributionLimitCurrency << 232);
            }

            // Set the overflow allowance if there is one.
            if (_fundAccessConstraints[_i].overflowAllowance > 0) {
                _packedOverflowAllowanceDataOf[_projectId][_configuration][_fundAccessConstraints[_i]
                    .terminal][_fundAccessConstraints[_i].token] = _fundAccessConstraints[_i]
                    .overflowAllowance | (_fundAccessConstraints[_i].overflowAllowanceCurrency << 232);
            }

            emit SetFundAccessConstraints(
                _configuration, _projectId, _fundAccessConstraints[_i], msg.sender
            );
