    ...
    IJBFundAccessConstraintsStore
{
    ...
    function distributionLimitsOf(
        ...
        uint256[] memory _packedDistributionLimitsData =
            _packedDistributionLimitsDataOf[_projectId][_configuration][_terminal][_token];
    ...
    function overflowAllowancesOf(
        ...
        // Get a reference to the packed data.
        uint256[] memory _packedOverflowAllowancesData =
            _packedOverflowAllowancesDataOf[_projectId][_configuration][_terminal][_token];
    ...
    function setFor(
        ...
        for (uint256 _i; _i < _numberOfFundAccessConstraints;) {
            ...
            for (uint256 _j; _j < _numberOfDistributionLimits;) {
                ...
                if (_distributionLimit.value > type(uint232).max) {
                ...
                if (
                    _j != 0
                        && _distributionLimit.currency
                            <= _constraints.distributionLimits[_j - 1].currency
                ...
                if (_distributionLimit.value > 0) {
                    _packedDistributionLimitsDataOf[_projectId][_configuration][_fundAccessConstraints[_i]
                        .terminal][_fundAccessConstraints[_i].token].push(
            ...
            for (uint256 _j; _j < _numberOfOverflowAllowances;) {
                ...
                if (_overflowAllowance.value > type(uint232).max) {
                ...
                if (
                    _j != 0
                        && _overflowAllowance.currency
                            <= _constraints.overflowAllowances[_j - 1].currency
                ...
                if (_overflowAllowance.value > 0) {
                    _packedOverflowAllowancesDataOf[_projectId][_configuration][_fundAccessConstraints[_i]
                        .terminal][_fundAccessConstraints[_i].token].push(
