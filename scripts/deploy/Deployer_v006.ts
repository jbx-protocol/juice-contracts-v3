...
async function main() {
    ...
    await deployRecordContract('NFTRewardDataSourceFactory', [], deployer, 'NFTRewardDataSourceFactory', deploymentLogPath);
    ...
    await verifyContract('Deployer_v006', deployerProxy.address, []);
