...
describe('JBSingleTokenPaymentTerminalStore3_1_1::recordPaymentFrom(...)', function () {
  const PROJECT_ID = 2;
  ...
  it('Should record payment with a datasource and emit event', async function () {
    ...
    await mockJbFundingCycleDataSource.mock.payParams
      ...
      .returns(WEIGHT, newMemo, [{ delegate: delegate.address, amount: 0, metadata: METADATA2 }]);
