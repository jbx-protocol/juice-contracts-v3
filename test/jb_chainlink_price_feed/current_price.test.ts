...
describe('JBChainlinkV3PriceFeed::currentPrice(...)', function () {
    ...
    beforeEach(async function () {
        ...
        aggregatorV3Contract = await deployMockContract(deployer, AggregatorV3InterfaceAbi);
    ...
    /**
     * Initializes mock price feed, adds it to JBPrices, and returns the fetched result.
     */
