...
describe('JBDirectory::setTerminalsOf(...)', function () {
    ...
    async function setup() {
        ...
        await mockJbFundingCycleStore.mock.currentOf.withArgs(PROJECT_ID).returns({
            ...
            metadata: packFundingCycleMetadata({ global: { allowSetTerminals: true, allowSetController: false, pauseTransfer: false } }),
        });
    ...
    it('Should add if the funding cycle prohibits it but the caller is the controller', async function () {
        ...
        await mockJbFundingCycleStore.mock.currentOf.withArgs(PROJECT_ID).returns({
            ...
            discountRate: 0,
            ballot: ethers.constants.AddressZero,
            metadata: packFundingCycleMetadata({ global: { allowSetTerminals: false, allowSetController: false, pauseTransfer: false } }),
        });
