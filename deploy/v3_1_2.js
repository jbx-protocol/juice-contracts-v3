...
/**
 * Deploys the Juicebox V3.1.2 contract ecosystem.
 *
 * Example usage:
 *
 * npx hardhat deploy --network goerli --tags 312
 */
module.exports = async ({ deployments, getChainId }) => {
  console.log('Deploying v3.1.2 contracts...');
  ...
  console.log({ ownerAddress, depAd: deployer.address });
  ...
  new ethers.Contract(JBController.address, JBController.abi);
  ...
  await deploy('JBETHPaymentTerminal3_1_2', {
    ...baseDeployArgs,
    contract: 'contracts/JBETHPaymentTerminal3_1_2.sol:JBETHPaymentTerminal3_1_2',
    args: [
      ETH,
      JBOperatorStore.address,
      JBProjects.address,
